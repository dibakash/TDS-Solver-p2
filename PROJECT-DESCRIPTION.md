...
> ![WARNING] The Demo API Project Endpoint is at <https://tds-llm-analysis.s-anand.net/project2>

> Actual API Project Endpoint may change and be given just before the below time.

> This will be active from 3:00 pm - 4:00 pm IST on Sat 13 Dec 2025.
...
> ![WARNING] This evaluation will start at Sat 13 Dec 2025 at 3:00 pm IST and end at 4:00 pm IST.

Your API endpoint will receive a POST request with a JSON payload containing your email, secret and a quiz URL, like this:

```jsonc
{
  "email": "22f1001491@ds.study.iitm.ac.in", // Student email ID
  "secret": "Sauce@123", // Student-provided secret
  "url": "https://tds-llm-analysis.s-anand.net/project2" // A unique task URL
  // ... other fields
}
```
