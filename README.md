...
│   ├── audio_transcribing.py   # Audio transcriber
│   ├── download_file.py        # File downloader
│   ├── encode_image_to_base64.py # Handle images encodings
│   ├── image_content_extracter.py # Handle images contents
│   ├── run.py # Python code executor
